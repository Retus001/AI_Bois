...
////// Emissive:
                ...
                float node_9430 = 1.0;
                float3 emissive = (lerp(_SkyColor.rgb,_HorizonColor.rgb,(pow((1.0 - max(0,dot(viewDirection,float3(0,-1,0)))),8.0)*_Mask_var.r))+(_LightColor0.rgb*pow(saturate((node_9430 + ( (max(0,dot((-1*lightDirection),viewDirection)) - node_1476) * (0.0 - node_9430) ) / ((1.0 - (node_9367*node_9367)) - node_1476))),5.0)*_SunIntensity));
